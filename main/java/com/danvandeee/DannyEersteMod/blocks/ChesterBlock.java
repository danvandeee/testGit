...
public class ChesterBlock extends ModBlockContainer {
	 ...
	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	    ...
	    public final ChesterBlock.Type chestType;

	    public ChesterBlock(String name, int swek)  //ChesterBlock.Type chestTypeIn
	    {
	    	super(Material.WOOD);
		    this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH));
		    
	    	if (swek == 0) {
	    		this.chestType = ChesterBlock.Type.BASIC;
	    		
	    	}
	    	else {
	    		this.chestType = ChesterBlock.Type.TRAP;
	    ...
	    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            if (ilockablecontainer != null)
	            {
	                ...
	                if (this.chestType == ChesterBlock.Type.BASIC)
	                {
	                    playerIn.addStat(StatList.CHEST_OPENED);
	                }
	                else if (this.chestType == ChesterBlock.Type.TRAP)
	                {
	    ...
	    {
	        return this.chestType == ChesterBlock.Type.TRAP;
	    }
