package com.danvandeee.DannyEersteMod.clients.renderer.tileentity;
...
public class ModTileEntityChestRenderer extends TileEntityChestRenderer {
    ...
    public ModTileEntityChestRenderer()
    {
